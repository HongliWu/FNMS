...
from algorithms.nms_util import *
...
if __name__  == "__main__":
    ...
    # single model
    before_nms_se_fnmsed = nms_fusion_result(before_nms_se, soft_nms=False, nms_thresh=0.05, fusion_thresh=0.6)
    check_metric(before_nms_se_fnmsed, thresh_strage='cvprw')
    before_nms_res2net_fnmsed = nms_fusion_result(before_nms_res2net, soft_nms=False, nms_thresh=0.05)
    check_metric(before_nms_res2net_fnmsed, thresh_strage='cvprw')
    print('single model ↑')

    data_fusioned = nms_fusion_result_2(before_nms_se, before_nms_res2net, fusion_thresh=0.5)
